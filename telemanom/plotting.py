...
class Plotter:
    def __init__(self, run_id, config_path='config.yaml'):
        ...
        self.run_id = run_id
        self.result_df = pd.read_csv(os.path.join('../../../../Download/tmep/Thesis', 'results', '{}.csv'
                                                  .format(self.run_id)))
    ...
    def plot_channel(self, channel_id, plot_train=False, plot_errors=True):
        ...
        plot_values = {
            'y_hat': np.load(os.path.join('../../../../Download/tmep/Thesis', 'data', self.run_id, 'y_hat',
                                          '{}.npy'.format(channel_id))),
            'smoothed_errors': np.load(os.path.join('../../../../Download/tmep/Thesis', 'data', self.run_id,
                                                    'smoothed_errors',
                                                    '{}.npy'.format(channel_id))),
            'test': np.load(os.path.join('../../../../Download/tmep/Thesis', 'data', 'test', '{}.npy'
                                         .format(channel_id))),
            'train': np.load(os.path.join('../../../../Download/tmep/Thesis', 'data', 'train', '{}.npy'
                                          .format(channel_id)))
        }
