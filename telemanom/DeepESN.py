...
class SimpleDeepReservoirLayer(keras.layers.Layer):
    ...
    def __init__(self, units=100, layers=2, concat=False,
...
class SimpleDeepESN(keras.Model):
    ...
    def __init__(self, units=100, layers=1, concat=False,
        ...
        self.hidden = tf.keras.models.Sequential()
        self.hidden.add(SimpleDeepReservoirLayer(units = units, layers = layers,
                                         concat = concat,
